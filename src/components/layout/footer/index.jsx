...
export const Footer = () => {
  return (
    <footer className=" dark:bg-gray-900 pt-[80px] bg-white  px-6">
        ...
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0 w-[292px]">
            <NavLink to="/" className="flex items-center">
              <span className="self-center text-2xl text-[#3563E9] font-[700] text-[32px] mb-4 whitespace-nowrap dark:text-white">
                MORENT
              </span>
            </NavLink>
